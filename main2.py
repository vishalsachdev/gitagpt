...
store.index = index
chain = VectorDBQAWithSourcesChain.from_llm(llm=OpenAI(temperature=0.0), vectorstore=store)
...
st.text("An AI bot trained on https://ocoy.org/read-our-books/introduction-gita-for-awakening/ ")
